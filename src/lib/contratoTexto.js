...
export const CLAUSULAS = [
  ...
  },
  {
    ...
    texto: (ctx) => `${ctx.escopoTexto} Este escopo reflete exatamente o plano contratado no momento da formalização deste contrato (SNAPSHOT), permanecendo válido para este contrato independentemente de alterações futuras no catálogo de produtos da CONTRATADA. Serviços, quantidades ou entregáveis não expressamente previstos neste escopo não integram a obrigação da CONTRATADA e podem ser objeto de novo orçamento/contratação.`,
  },
  {
  ...
  {
    titulo: 'CLÁUSULA 6ª-A — DO SINAL, RESERVA DE AGENDA E CANCELAMENTO/ADIAMENTO',
    texto: () => `Quando a contratação envolver produção presencial e/ou gravação agendada, o valor pago a título de sinal/entrada não representa apenas parte antecipada do preço, mas também compensação pela reserva de agenda, bloqueio de datas, planejamento e alocação de equipe e equipamentos, preparação técnica e programação da edição/produção subsequente — atividades que a CONTRATADA realiza a partir da confirmação da contratação e que mobilizam sua capacidade produtiva. Sendo o contrato executado normalmente, o valor pago a título de sinal/entrada será integralmente abatido do valor total do serviço/produto contratado, restando ao CONTRATANTE apenas o saldo devedor (por exemplo: em uma contratação de R$ 4.000,00 com sinal de 10%, isto é, R$ 400,00, o saldo a pagar será de R$ 3.600,00). Em caso de cancelamento ou adiamento por iniciativa do CONTRATANTE, sem motivo justo e sem prévio alinhamento com a CONTRATADA, o valor pago a título de sinal poderá ser retido pela CONTRATADA como compensação pela reserva de agenda, planejamento e eventuais prejuízos decorrentes, observados os limites e requisitos da legislação civil e consumerista aplicável, em especial quanto à razoabilidade e proporcionalidade da retenção. Situações previamente alinhadas entre as partes — incluindo remarcação acordada, impossibilidade da CONTRATADA ou caso fortuito/força maior — poderão receber tratamento diferenciado, a ser definido de comum acordo entre as partes, não se aplicando a retenção automática nessas hipóteses. Esta cláusula não confere à CONTRATADA direito absoluto e incondicional de retenção de valores independentemente da situação concreta.`,
  },
  {
