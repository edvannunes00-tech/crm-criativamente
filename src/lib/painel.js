...
// Cria o conjunto padrão de widgets pra quem ainda não personalizou nada
export function widgetsPadrao(pagina) {
  if (pagina === 'dashboard') {
    return [
      { titulo: 'Precisa de Atenção Agora', fonte_dados: 'atencao_hoje', tipo_visual: 'texto', largura: 12 },
    ];
  }
  return [
    { titulo: 'Indicadores Comerciais', fonte_dados: 'indicadores_comerciais', tipo_visual: 'card', largura: 12 },
    { titulo: 'Funil de Conversão', fonte_dados: 'funil_conversao', tipo_visual: 'barra', largura: 6 },
    { titulo: 'Apontamentos', fonte_dados: 'apontamentos_gerenciais', tipo_visual: 'texto', largura: 6 },
  ];
}
