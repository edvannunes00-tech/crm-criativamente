-- Contratos — Migration 18 (corrigida pela migration 20 — ambiguidade de
-- contrato_id no RETURNING; mantida aqui so como registro historico da
-- primeira versao)
create function crm.registrar_assinatura_contrato(p_token_hash text, p_storage_path text)
